...
2. get_product_basic_info - Cho câu hỏi về thông tin sản phẩm (tên, mô tả, chất liệu, v.v.)
...
- "chất liệu gì", "làm bằng gì" → get_product_basic_info (kiểm tra trong mô tả/thuộc tính)
